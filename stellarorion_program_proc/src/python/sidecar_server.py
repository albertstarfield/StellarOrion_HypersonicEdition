# Parity protection: metadata/sidecar_server.meta.json (RS+GC parity)
...
# References: metadata/sidecar_server.meta.json, par2-one, par2-two
...
# def store_parity_blocks(source_path, blocks):
    # Store parity blocks to metadata/sidecar_server.par2-one and par2-two.
    # pass
# def verify_parity_integrity(source_path):
    # Verify parity integrity against metadata/sidecar_server.meta.json.
    # pass
