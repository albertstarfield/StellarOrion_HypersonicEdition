...
This chapter has established the research context by presenting the background on hypersonic inflatable aerodynamic decelerators (HIADs), identifying the critical need for accurate aerothermal analysis in the transitional flow regime, and defining eight specific research objectives. The novelty of this work lies in the first integrated DSMC-PINN-optimization framework for HIAD design, which addresses four identified research gaps in rarefied regime modeling, automated design space exploration, PINN-DSMC hybrid approaches, and multi-objective survivability optimization.
