...
package StellarOrion_Geometry is
   ...
   -- [Citation: ISO 26262 §9.4.3, DO-178C §6.4.4]
    ...
    procedure Test_Cos_Rad
      with Pre => True, Post => True;
    -- @test: main
    -- Register_Routine: "Test_Cos_Deg"
    -- Register_Routine: "Test_Sin_Rad"
    -- Register_Routine: "Test_Cos_Rad"
--
-- References:
...
-- References: metadata/stellarorion_geometry.meta.json, par2-one, par2-two
...
--     """Store parity blocks to metadata/stellarorion_geometry.par2-one and par2-two."""
--     pass
-- def verify_parity_integrity(source_path):
--     """Verify parity integrity against metadata/stellarorion_geometry.meta.json."""
--     pass
