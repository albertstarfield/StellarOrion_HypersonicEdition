...
When using the "High-Fidelity SBO" mode, the optimization targets for heat flux and g-load are initially set to 1.5x IRVE-3 limits to allow the optimizer to explore "Survivability Envelopes" for future Mars-scale missions (e.g., LOFTID) (Lau et al., 2013 / Lippincott et al., 2019).
