# Parity protection: metadata/sidecar_launcher.meta.json (RS+GC parity)
"""StellarOrion Sidecar UI launcher.

Starts the web-based monitoring UI that communicates with the Ada
binary via the local REST API.
"""

# -- Split Parity Protection (audit compliance) --
# References: metadata/sidecar_launcher.meta.json, par2-one, par2-two
...
# def store_parity_blocks(source_path, blocks):
    # Store parity blocks to metadata/sidecar_launcher.par2-one and par2-two.
    # pass
# def verify_parity_integrity(source_path):
    # Verify parity integrity against metadata/sidecar_launcher.meta.json.
    # pass
