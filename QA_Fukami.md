Generalized super resoltion

Hello first i hope you have an absolutely wonderful today. 2nd I'm sorry that strange whimsical entry on the 6 minute late, i'll try to fix that mis-scheduling slowly on my said

But anyway I would say thank you for this material DSC and Machine learning reconstruction and how to debug such thing and visualize such thing and that Autoencoder and informative M (i forgot) Decomposition mode ML insights (it's just compressed)
...
depends... welp POD analysis? and Autoencoder usage?
datadriveen fluid dynamics Autoencoder(?????) maybe this is the answer for acceleration

Cost function definition function then 

Lower order manifold manifold based vehicle shape optimization (like vertex gradient descent based shape optimization in latent space) Iteration based

POD + Observeabe nonlinear autoencoder
GeoDetecter system?

Your Recomendation and response will very useful for me to where to go to the next step and to be honest with you if it's possible there's an pipelien i want to discuss about this in the future.



(subsampling based data generation?)

contact
kfukami1@tohoku.ac.jp Kai Fukami
