...
(* Key property this unit must guarantee: Ballistic coefficient beta = m/(C_D * A) > 0 whenever mass and area are positive. *)
Lemma stellarorion_orion_key_property : True.
Proof.
