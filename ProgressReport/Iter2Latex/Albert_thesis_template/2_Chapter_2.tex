...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/hypersonicMachandShockRelation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/aerodynamicHighShockBody.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/bowshock_figure1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/aerospace-09-00800-g001-bluntbodyTheory.png}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{gambar/FigureTPSType0.png}
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{gambar/FigureTPSType1.png}
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{gambar/FigureTPSType2.png}
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{gambar/FigureTPSType3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/ReinforcedNoseStaticTPS.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/LOFTID_mission_trajectory.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/HIADsDeployed.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/GolfBallImpactReImpact.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/swblishockinteract.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/RecirculationExample.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/LocalizedHeatinginAmplify.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/elocity-contour-for-different-values-of-velocity-for-SST-K-o-model.jpg.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{gambar/sutherlandfx.png}
