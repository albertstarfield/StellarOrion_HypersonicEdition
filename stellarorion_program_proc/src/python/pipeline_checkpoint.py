# Parity protection: metadata/pipeline_checkpoint.meta.json (RS+GC parity)
...
class StepStatus(str, Enum):
    ...
    References:
    - https://docs.python.org/3/library/enum.html#creating-a-new-enumeration
    """
    PENDING = "pending"
    RUNNING = "running"
    COMPLETED = "completed"
...
# References: metadata/pipeline_checkpoint.meta.json, par2-one, par2-two
...
# def store_parity_blocks(source_path, blocks):
    # Store parity blocks to metadata/pipeline_checkpoint.par2-one and par2-two.
    # pass
# def verify_parity_integrity(source_path):
    # Verify parity integrity against metadata/pipeline_checkpoint.meta.json.
    # pass
