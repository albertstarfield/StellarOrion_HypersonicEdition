...
The survivability optimization framework (Sec.~3.4) was executed across multiple runs to explore the HIAD design space using Latin Hypercube Sampling (LHS), Bayesian Optimization (GP Matérn 5/2 + Expected Improvement) surrogate training, and Genetic Algorithm (GA) optimization. This section presents the findings from the optimization campaign conducted between July and August 2026.
...
\begin{table}[H]
    ...
    \begin{tabular}{p{3.5cm} p{5cm} p{5cm}}
        ...
        Optimization & Sequential parametric sweeps & GA + Bayes Opt (GP) surrogate \\
