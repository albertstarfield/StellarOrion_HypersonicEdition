...
The SPARTA DSMC simulation framework was validated against the IRVE-3 post-flight aerothermal reconstruction data~\cite{lau2013irve3}. The Sutton-Graves stagnation-point correlation~\cite{sutton1971gravesh} predicts a peak heat flux of 19.0\,W/cm$^2$ for the baseline IRVE-3 configuration at 52\,km altitude ($V_{\infty} = 2700$\,m/s, $\rho_{\infty} = 1.67 \times 10^{-4}$\,kg/m$^3$). This represents a conservative upper bound relative to the 13.8\,W/cm$^2$ flight measurement, with the discrepancy attributable to the Sutton-Graves assumption of a spherical nose cap that does not account for the HIAD's flared geometry. The total heat load and peak deceleration predictions are within 4\% and 3\% of flight data, respectively, confirming the framework's predictive capability.
