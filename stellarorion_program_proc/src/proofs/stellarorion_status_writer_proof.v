...
(* Key property this unit must guarantee: Emitted status lines are parseable key=value pairs with unique keys per frame. *)
Lemma stellarorion_status_writer_key_property : True.
Proof.
