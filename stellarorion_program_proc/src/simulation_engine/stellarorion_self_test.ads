...
--  Runs the 18 self-tests covering physics, geometry, environment,
...
package StellarOrion_Self_Test is
   ...
   --  Execute all 18 self-tests; prints [TEST nn] PASS/FAIL lines and
   --  the final "All 18 self-tests PASSED." banner. Exits via exception
